...
//endpoint=http://pastebin.com/api/api_post.php
	...
	public static String postString (ArrayList<String> contents, Properties props) throws Exception{
		...
		nvps.add(new BasicNameValuePair("api_paste_name", contents.get(0)));
		nvps.add(new BasicNameValuePair("api_paste_code", contents.get(1)));
